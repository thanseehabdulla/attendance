 ...
 */
public class Webv3 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!DetectConnection.checkInternetConnection(this)) {
            ...
            w.loadUrl("http://webmail.aceinfolabs.com/cpsess1319979588/webmail/paper_lantern/index.html?mailclient=roundcube&login=1&post_login=99149615948295");
...
w.getSettings().setDatabaseEnabled(true);
        ...
        swipeLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                ...
                if (!DetectConnection.checkInternetConnection(Webv3.this)) {
                    Toast.makeText(getApplicationContext(), "No Internet!", Toast.LENGTH_SHORT).show();
